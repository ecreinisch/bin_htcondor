...
tar -czf GMT5SAR_v54.tgz -C /home/ebaluyut GMT5SAR5.4 
tar -czf ssh.tgz .ssh
if [[ "$user" != "ebaluyut" ]]
then
...
then
  echo "Missing setup_gmtsarv54.sh script.  Copy from /home/ebaluyut and replace maule account name with your own"
  exit 1
...
transfer_input_files = run_pair.sh, bin_htcondor.tgz, setup_gmtsarv54.sh, GMT5SAR_v54.tgz,  gmtsar_dependencies.tgz, ssh.tgz,  GMT.tgz ${orbittar}

...
#       $Id$
#  D. Sandwell 1/12/07
# Elena Reinisch 20160909 add option for 20 m grid for Brady demcut_ll.grd 
# look for #ELENA# to uncomment out if statement which selects resolution based on sampling rate
#
#
alias rm 'rm -f'
unset noclobber
...
#ELENA#if ($rng_samp_rate > 35000000 && $PRF > 1000 ) then
# use a 20 m grid for Brady demcut_ll.grd spacing 
#
  gmt blockmedian llp `gmt gmtinfo llp -I7.2s -bi3f ` -bi3f -bo3f -I0.72s -r -V > llpb
  gmt xyz2grd llpb `gmt gmtinfo llpb -I7.2s -bi3f ` -I0.72s -r -fg -G$3 -bi3f

## use a 30 m grid
##
#  gmt blockmedian llp `gmt gmtinfo llp -I10s -bi3f ` -bi3f -bo3f -I1s -r -V > llpb
#  gmt xyz2grd llpb `gmt gmtinfo llpb -I10s -bi3f ` -I1s -r -fg -G$3 -bi3f
...
# use a 120 m grid
#
#ELENA#   gmt blockmedian llp `gmt gmtinfo llp -I40s -bi3f ` -bi3f -bo3f -I4s -r -V > llpb
#ELENA#   gmt xyz2grd llpb `gmt gmtinfo llpb -I40s -bi3f ` -I4s -r -fg -G$3 -bi3f
#

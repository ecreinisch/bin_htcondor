...
#  20210318 Kurt Feigl remove -e switch on first line (originally -vexf)
...
#  Start preprocessing
#  
#   2021/03/18 Kurt Feigl:
#   the following three lines will cause a show-stopping error 
#   with the -e flag on csh if the files do not exist

    touch raw/junk.PRM raw/junk.SLC raw/junk.LED
    rm raw/*.PRM*
    rm raw/*.SLC
    rm raw/*.LED
